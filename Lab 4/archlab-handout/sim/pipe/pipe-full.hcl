...
# The iaddl instruction adds an immediate number to a given register
...
# The leave instruction is unimplemented in pipe because the overhead
# from the epilouge is not sufficent to justify the effort.
